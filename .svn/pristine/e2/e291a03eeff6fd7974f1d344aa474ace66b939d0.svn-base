                        ...
                        <section class="main">
                           ...
                           <div class="table-wrapper">
                              <div style="justify-content:space-between; width: 1000px; height: 31px;">
                                 <button class="button" style="border-radius:0; background: #65cdd2; color: white; border-color: #65cdd2;float: right;" onclick="location.href='${pageContext.request.contextPath}/boards/BoardsWrite.bo?type='+${type}">글 쓰기</button>
                              </div>
